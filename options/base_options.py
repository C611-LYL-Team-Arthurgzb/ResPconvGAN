...
class BaseOptions():
    ...
    def initialize(self, parser):
        # parser.add_argument('--dataroot', default='/home/gzb/20190412/all_data', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument('--maskroot', default='/home/gzb/20190412/myData', help='path to mask ')
        # parser.add_argument('--GTroot', default='/home/gzb/20190412/all_gt', help='path to mask ')
        parser.add_argument('--dataroot', default=r'F:\data\new\aacc\cc-data', help='test')
        parser.add_argument('--maskroot', default=r'F:\data\new\aacc\my-mask', help='test path to mask ')
        parser.add_argument('--GTroot', default=r'F:\data\new\DDD', help='test ')
        ...
        parser.add_argument('--model', type=str, default='rpnet', \
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./log0315', help='models are saved here')
        ...
        parser.add_argument('--display_winsize', type=int, default=32,  help='display window size')
